/* This file contains references to the vendor libraries
   ...
   in the production build onlu*. A seperate bundle for vendor
   code is useful since it is unlikely to change as often
   ...
   of code changes. They inly have to download vendor.js when
